<?php 
   ...
   $to = 'igor@sfera-adria.hr'; 
   $subject = 'Poruka s sfera-adria kontakt forma ';
...
$("#contactForm")validate({
			...
			$.post("<?php echo $_SERVER[PHP_SELF]; ?>", //post
				$("#contactForm").serialize(), function(data){
				  //if message is sent
				  if (data == 'Sent') {
				    $("#thx").fadeIn(); //show confirmation message
...
<div class="main-nav" style="float:left;">
 ...
 <header class="header" id="header"><!--header-start-->
    ...
    <a href="../index.html"><img src="../img/logo_bl.png" alt="Sfera Adria d.o.o logo" id="logo"></a>
</div> 
...
<div class="row">        
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12  col-lg-offset-3  col-md-offset-2">
<p style="color:#ffffff;" class="onamaKontakt">  
Sfera Adria d.o.o.
<br/>
...
<br/>
 <div class="col-lg-12 col-sm-12 col-xs-12">
  <textarea name="message" rows="10" cols="50"   role="textbox" aria-autocomplete="list" aria-haspopup="true"  placeholder="Tekst Vaše poruke">
...
<br/>
 <div class="col-lg-12 col-sm-12 col-xs-12">
  <div style="text-align: center;">
		 <button class="raise" name="submit" type="submit" value="Send">Pošalji</button>
		<br/>
...
width="160" height="21" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="false">        
 ...
 <div style="padding-top: 15px; text-align: center;" class="menu_social_iconsFoot"> 
         ...
         <a href=""> <img src="../img/menuIcons/Facebook.png" alt="" class="img-center"/></a>
           <a href=""> <img src="../img/menuIcons/Twitter.png" alt=""/> </a>
          <a href="">  <img src="../img/menuIcons/Pinterest.png" alt=""/> </a>
           <a href=""> <img src="../img/menuIcons/Google+.png" alt=""/> </a>
 </div>  
